...
export const DOMAIN = typeof globalThis !== 'undefined' && 'location' in globalThis ? globalThis.location.hostname : ''

export const getUniqueHostnameString = (inputString: string) => inputString.replaceAll('.', '_').replaceAll('-', '_')

export const DEFAULT_AUTH_SUFFIX_KEY = getUniqueHostnameString(DOMAIN)
