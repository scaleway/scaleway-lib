...
export type CheckPermissionsResponseResponseDecision = 'deny' | 'allow'
...
export type OAuth2IdentityProvider = 'unknown_identity_provider' | 'google' | 'microsoft' | 'github'
...
export type ConnectionConnectedOrganization = {
  id: string
  name: string
  locked: boolean
}
export type ConnectionConnectedUser = {
  id: string
  username: string
  type: UserType
}
export type CheckPermissionsResponseResponse = {
  decision: CheckPermissionsResponseResponseDecision
}
export type JWT = {
  /**
   * JWT ID.
...
export type CreateUserRequestMember = {
  /**
...
export type CheckPermissionsResponse = {
  responses: CheckPermissionsResponseResponse[]
}
export type ClonePolicyRequest = {
  policyId: string
}
export type CommitLoginResponse = {
  /**
   * A JWT authenticating the user.
   */
  jwt?: JWT
  /**
   * The plain text content of the JWT.
   */
  token: string
  /**
   * A token that can be used to renew the JWT.
   */
  renewToken: string
}
...
export type FinishUserWebAuthnRegistrationResponse = {
  /**
...
export type InitiateOAuth2LoginResponse = {
  /**
...
export type InitiateSamlLoginResponse = {
  /**
   * The SAML AuthnRequest to send to the identity provider.
   */
  samlRequest: string
  /**
   * The relay state to send to the identity provider.
   */
  relayState: string
  /**
...
export type InitiateUserConnectionResponse = {
  /**
...
export type ListGracePeriodsResponse = {
  /**
...
export type ListPermissionSetsResponse = {
  /**
...
export type ListSamlCertificatesResponse = {
  /**
...
export type ListScimTokensResponse = {
  /**
   * List of SCIM tokens.
   */
...
export type Login = {
  /**
   * A UUID representing the login attempt.
   */
  id: string
  /**
   * Whether the login attempt expects a MFA token.
   */
  mfaRequired: boolean
}
export type MFAOTP = {
...
export type OrganizationSummary = {
  ...
  name: string
  /**
   * Defines whether the organization supports login via Password.
   */
  loginPasswordEnabled: boolean
  /**
   * Defines whether the organization supports login via Magic Code.
   */
  loginMagicCodeEnabled: boolean
  /**
   * Defines whether the organization supports login via OAuth2 SSO.
   */
  loginOauth2Enabled: boolean
  /**
   * Defines whether the organization supports login via SAML SSO.
   */
  loginSamlEnabled: boolean
}
...
export type ParseSamlMetadataResponse = {
...
export type SetRulesResponse = {
  /**
   * Rules of the policy.
   */
  rules: Rule[]
}
export type StartLoginMFAWebAuthnResponse = {
  /**
...
export type StartUserWebAuthnRegistrationResponse = {
  /**
...
export type UnauthenticatedApiCheckLoginMFAOTPRequest = {
  /**
   * The ID of the login object for which to check MFA OTP.
   */
  loginId: string
  /**
   * Either a one time password or a recovery code for the OTP method registered.
   */
  oneTimePassword: string
}
export type UnauthenticatedApiCommitLoginRequest = {
  /**
   * The ID of the login object to log in on.
   */
  loginId: string
}
export type UnauthenticatedApiCreateMagicCodeLoginRequest = {
  /**
   * The UUID of the organization on which to login.
   */
  organizationId?: string
  /**
  ...
  username: string
  /**
   * The magic code received via email.
   */
  magicCode: string
}
export type UnauthenticatedApiCreateOAuth2LoginRequest = {
  /**
   * The UUID of the organization on which to login.
   */
  organizationId?: string
   ...
   */
  identityProvider?: OAuth2IdentityProvider
  /**
...
export type UnauthenticatedApiCreatePasswordLoginRequest = {
  /**
   * The UUID of the organization on which to login.
   */
  organizationId?: string
...
export type UnauthenticatedApiFinishLoginMFAWebAuthnRequest = {
  /**
   * ID of the login object for which to finish a WebAuthn MFA.
   */
  loginId: string
  /**
...
export type UnauthenticatedApiGetSamlMetadataRequest = {
  /**
   * The ID of the SAML configuration to get the metadata for.
   */
  samlId: string
}
export type UnauthenticatedApiInitiateMagicCodeLoginRequest = {
  /**
   * The UUID of the organization on which to login.
   */
  organizationId?: string
...
export type UnauthenticatedApiInitiateOAuth2LoginRequest = {
  /**
   * The UUID of the organization on which to login.
   */
  organizationId?: string
...
export type UnauthenticatedApiInitiateSamlLoginRequest = {
  /**
   * The UUID of the organization on which to login.
   */
  organizationId?: string
  /**
   * URI to redirect to after the SAML authentication phase.
   */
  redirectUri: string
}
...
export type UnauthenticatedApiSearchOrganizationRequest = {
  /**
   * Search for an organization using its ID.
   *
   * One-of ('filter'): at most one of 'organizationId', 'organizationAlias' could be set.
   */
  organizationId?: string
  /**
   * Search for an organization using its alias.
   *
   * One-of ('filter'): at most one of 'organizationId', 'organizationAlias' could be set.
   */
  organizationAlias?: string
}
export type UnauthenticatedApiStartLoginMFAWebAuthnRequest = {
  /**
   * The ID of the login object for which to start a Webauthn MFA.
   */
  loginId: string
  /**
   * The URL origin of the request.
   */
  origin: string
}
...
export type ValidateUserMFAOTPResponse = {
  /**
